...
public class TestController {
	...
	@GetMapping("/show")
	public String showPostForm(Model model,	@RequestParam(value = "page", defaultValue = "0") int page, 
		...
		// -> model.addAttribue(ui에서 사용할 객체명, 넘길 인스턴스);
		return "board";
	}
	...
	public String createPost(@Valid @ModelAttribute("dto") PostCreateDto dto, BindingResult bindingResult,
		...
		// (bindingResult 관련해서)
		//  -> 그럴 때는 해당 dto나 엔티티 객체에 위에 적힌 어노테이션을 사용할 것
